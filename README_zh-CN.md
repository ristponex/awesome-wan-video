...
> 💡 **专业提示：** [注册 Atlas Cloud](https://www.atlascloud.ai?ref=JPM683) 首次充值 **额外赠送 25%**（最高 $100 奖金）。$100+$25 奖金可生成多达 1,785 个 Wan Spicy 视频或 1,785+ 个 Wan 2.6 视频！
...
对比 Sora（$0.50+/视频）或 Runway（$0.50+/视频）。[立即开始 →](https://www.atlascloud.ai?ref=JPM683)
...
**Wan 2.7** 目前正在开发中，即将发布。Atlas Cloud 将是首批提供 Wan 2.7 API 的平台之一。[注册 Atlas Cloud](https://www.atlascloud.ai?ref=JPM683) 以在 Wan 2.7 上线时第一时间获得通知。
...
[![在 Atlas Cloud 上试用 Wan](https://img.shields.io/badge/👉%20在%20Atlas%20Cloud%20上试用%20Wan-blue?style=for-the-badge&logo=cloud&logoColor=white)](https://www.atlascloud.ai?ref=JPM683)
